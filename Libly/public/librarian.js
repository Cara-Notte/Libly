// librarian.js - functionality for the librarian panel (book and review management only)

document.addEventListener('DOMContentLoaded', () => {
    const currentUser = localStorage.getItem('currentUser');
    const currentUserRole = localStorage.getItem('currentUserRole');
    // Only allow access to librarians and admins
    if (!currentUser || (currentUserRole !== 'librarian' && currentUserRole !== 'admin')) {
        window.location.href = 'index.html';
        return;
    }
    // Update UI with librarian username
...
// Display books in librarian panel
...
// Load reviews for librarian management
...
// Render reviews in librarian panel
...
// Create librarian review element
...
// Update librarian reviews count
...
async function deleteReview(reviewId) {
    ...
    try {
        ...
        if (response.ok) {
            ...
            loadLibrarianReviews(); // Refresh the list
        } else {
